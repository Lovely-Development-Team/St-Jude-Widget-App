        ...
        Group {
            VStack(spacing:self.spacing) {
                HStack(spacing:self.spacing) {
                    ...
                    Image.flexibleImageAtScale(self.positionImage(for: .top), scale: self.scale, axis: .horizontal)
                    Image.imageAtScale(self.positionImage(for: .topRight), scale: self.scale)
                }
                HStack(spacing:self.spacing) {
                    Image.flexibleImageAtScale(self.positionImage(for: .left), scale: self.scale, axis: .vertical)
                    Spacer()
                    Image.flexibleImageAtScale(self.positionImage(for: .right), scale: self.scale, axis: .vertical)
                }
                HStack(spacing:self.spacing) {
                    Image.imageAtScale(self.positionImage(for: .bottomLeft), scale: self.scale)
                    Image.flexibleImageAtScale(self.positionImage(for: .bottom), scale: self.scale, axis: .horizontal)
